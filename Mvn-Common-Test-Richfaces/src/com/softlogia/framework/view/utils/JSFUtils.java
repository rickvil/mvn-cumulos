...
public class JSFUtils {
     ...
     * @param object value to store
     */
    public static void storeOnHttpSession(String key, Object object) {
        FacesContext ctx = getFacesContext();
     ...
     * @return session object for key
     */
    public static Object getFromHttpSession(String key) {
        FacesContext ctx = getFacesContext();
        HttpSession sessionState = (HttpSession)ctx.getExternalContext().getSession(true);
